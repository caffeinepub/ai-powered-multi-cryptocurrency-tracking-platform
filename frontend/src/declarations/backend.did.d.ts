...
export interface _SERVICE {
  ...
  'getAllCryptosLiveData' : ActorMethod<[], string>,
  'getCachedPriceHistory' : ActorMethod<[], Array<PriceCache>>,
  'getCachedTopCryptos' : ActorMethod<[], Array<Coin>>,
  'getCachedUNIPriceHistory' : ActorMethod<[], Array<PriceCache>>,
  ...
  'getUNILivePrice' : ActorMethod<[], string>,
  'getUserProfile' : ActorMethod<[Principal], [] | [UserProfile]>,
  'isCallerAdmin' : ActorMethod<[], boolean>,
  'recordNewICPPrice' : ActorMethod<[number], undefined>,
  'recordNewUNIPrice' : ActorMethod<[number], undefined>,
