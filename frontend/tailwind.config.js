  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Custom accent tokens for crypto theme
        'cyan-accent': 'oklch(var(--cyan-accent))',
      ...
      boxShadow: {
        ...
        'glow-cyan': '0 0 20px oklch(0.78 0.18 195 / 0.25)',
        'glow-gold': '0 0 20px oklch(0.78 0.18 80 / 0.25)',
      },
      keyframes: {
        'accordion-down': {
          from: { height: '0' },
